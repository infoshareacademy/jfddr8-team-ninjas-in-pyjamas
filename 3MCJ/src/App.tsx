...
function App() {
  const { setShoppingCartItems, setShoppingCartValue, isLogged, setIsLogged } =
        ...
        try {
          ...
          if (shoppingCartDetailsSnapshot.exists()) {
            setShoppingCartItems(
              shoppingCartDetailsSnapshot.data().shoppingCartItems
            );
            setShoppingCartValue(
              shoppingCartDetailsSnapshot.data().shoppingCartValue
            );
          }
        } catch (error) {

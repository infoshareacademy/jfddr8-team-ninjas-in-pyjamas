...
describe("Registration component", () => {
    beforeEach(() => {
      cy.visit("https://infoshareacademy.github.io/jfddr8-team-ninjas-in-pyjamas/#/registration"); 
    });
    ...
    it("submits the form with valid data", () => {
      ...
      cy.url().should("include", "https://infoshareacademy.github.io/jfddr8-team-ninjas-in-pyjamas/");
    });
